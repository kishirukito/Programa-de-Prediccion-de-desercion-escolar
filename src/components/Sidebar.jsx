...
const navItems = [
  ...
  {
    path: '/docentes', label: 'Docentes y Tutores',
    ...
    <aside id="sidebar" className="sidebar">
      ...
      <div className="sidebar-header">
        ...
        <div className="sidebar-brand">
          <h2>UNIPOLI</h2>
          <span>PagAlumnos</span>
        </div>
      </div>

      {/* Nav — una sola sección */}
      ...
      <div className="sidebar-footer">
        <div className="sidebar-user">
          ...
          <button onClick={handleLogout} className="btn btn-ghost btn-sm" title="Cerrar sesión" style={{ marginLeft: 'auto' }}>
