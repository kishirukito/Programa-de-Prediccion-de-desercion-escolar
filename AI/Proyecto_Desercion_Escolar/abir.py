...
def exportar_excel():
    hora = str(tm.ctime()).replace(' ','_').replace(':','-')
    df_estudiantes.to_excel(f'estudiantes_optimizado_{hora}.xlsx', header=True, index=False)
...
def exportar_excel():
    try:
        ...
        nombre_ruta = r"C:\Users\ios27\OneDrive\Escritorio\Codigo\AI\Proyecto_Desercion_Escolar\resutados_prueba\optimizado"
